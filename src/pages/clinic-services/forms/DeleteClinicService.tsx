...
import { DeleteClinicServiceModel } from "@/model";
...
const DeleteService = ({ open, setOpen, serviceId }: Props) => {
  const { trigger } = DeleteClinicServiceModel(serviceId);
  ...
  const onSubmit = async (values: any) => {
    ...
    await fetch("/api/delete-clinic-service", {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Confirm Delete Clinic Service
                  </Dialog.Title>
                  <div className="mt-6 px-3">
                    <span>
                      Are you sure you want to delete the Clinic Service?
                    </span>
                    <Formik
                      onSubmit={onSubmit}
